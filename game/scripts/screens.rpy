...
#
# Este archivo esta basado en la configuracion predeterminada de Ren'py
##################################################################################
...
## Espaciado entre botones  
        ...
        #textbutton define un boton con texto
        #action es la accion que hace el boton
...
# si el titulo es una imagen se pone:
# add "ruta/de/la/imagen" xalign 0.7 yalign 0.4
